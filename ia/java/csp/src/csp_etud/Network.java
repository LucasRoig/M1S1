...
public class Network {
    ...
    /**
     * Ajoute une nouvelle variable dans le réseau avec un domaine vide (ne fait
     * rien si la variable existe déjà : message d'avertissement)
     *
     * @param var la variable à ajouter
     */
    public void addVariable(String var) {
        if (varDom.get(var) == null) {
            varDom.put(var, new ArrayList<Object>());
        } else {
