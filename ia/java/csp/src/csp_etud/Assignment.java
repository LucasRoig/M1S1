...
/**
 *
 * Permet la manipulation aisée des assignations. Une assignation (Assignment)
 * est un ensemble de couples (variable, valeur associée). Les noms des
 * variables sont des chaînes de caractères (String) Leurs valeurs sont des
 * objects quelconques (Object).
 *
...
public class Assignment extends HashMap<String, Object> {
    ...
    /**
     * Retourne une copie "superficielle" de l'assignation (copie de la hashmap,
     * mais pas de recopie des variables et des valeurs) Cette copie suffit si
     * on ne modifie pas le nom d'une variable ni un objet valeur lui-même
     *
    ...
    /**
     * Retourne la liste des variables de l'assignation (c'est à dire toutes les
     * variables assignées)
     *
